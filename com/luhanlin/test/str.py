...
# 切片
print(s[0], s[-1], s[2:], s[::-1])  # 学 n Python nohtyP习学
...
# encode 将字符转换为字节
print(s.encode())			# 默认编码是 UTF-8  输出：b'\xe5\xad\xa6\xe4\xb9\xa0Python'
print(s.encode('gbk'))      # 输出  b'\xd1\xa7\xcf\xb0Python'

# decode 将字节转换为字符
print(s.encode().decode('utf8'))                # 输出 '学习Python'
print(s.encode('gbk').decode('gbk'))            # 输出 '学习Python'
